...
class FrontendServerTests(unittest.TestCase):
    ...
    def test_frontend_static_files_include_review_close_control(self):
        ...
        self.assertIn("grid-template-columns: minmax(0, 1fr) minmax(22rem, 28rem)", style_response.text)
        ...
        self.assertIn("CustAnnoX", remotion_source)
        self.assertIn("客服标注平台", remotion_source)
        ...
        self.assertIn("left: 150", remotion_source)
        self.assertIn("top: 410", remotion_source)
        ...
        self.assertIn("loop={false}", remotion_source)
        ...
        self.assertIn("CustAnnoX", remotion_response.text)
