...
12. 像“换一个”“留个新地址”“重新登记地址”“改个地址”这类只是要求重新登记、但没有提供真实地址内容的话，必须返回空字符串，granularity=non_address。
13. 如果用户先否认再给出真实地址，例如“不是，江苏省扬州市宝应县御景豪庭”，要把否认部分去掉，只提取后面的真实地址。
14. 如果用户说“换个地址，三门县江南壹号”“留个新地址，徐泾镇西郊一区”“改成南京农业大学卫岗校区”，前半句只是换址意图，真正的地址内容是后半句；不要把“换个地址”“留个新地址”混进地址槽位。
